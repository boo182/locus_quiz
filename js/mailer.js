const sendMail = (name, results) => {
  const total = results.in + results.out;
  const inPercent = Math.floor((results.in * 100) / total);
  const outPercent = Math.floor((results.out * 100) / total);
  ...
  Email.send({
    ...
    To: name,
    From: "julien.dupont02@kedgebs.com",
                        ...
                        <tbody>
                          <tr>
                            <td valign="top" class="edtext" style="padding: 20px; text-align: left; color: #5f5f5f; font-size: 12px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;">
                              <p class="style1 text-center" style="text-align: center; margin: 0px; padding: 0px; color: #000000; font-size: 32px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">Résultat du test de Locus<b><strong></strong></b></p><p class="style1 text-center" style="text-align: center; margin: 0px; padding: 0px; color: #000000; font-size: 32px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;">de:&nbsp;</p><p class="style1 text-center" style="text-align: center; margin: 0px; padding: 0px; color: #000000; font-size: 32px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;"><strong>${name}</strong></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
